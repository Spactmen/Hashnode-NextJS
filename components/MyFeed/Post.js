        ...
        <div className='p-5 border-b border-grey'>
            ...
            <div className='relative mb-2'>
                ...
                <a className='hidden absolute top-0 right-0  items-center rounded-full text-xs font-bold py-1 px-2 bg-light-green uppercase border border-grey md:flex' >
                    ...
                    <span className='tracking-wide text-green font-primary '>Featured</span>
                </a>
            </div>
                ...
                <div className='mt-3 flex w-full md:mt-0 md:flex-1'>
                    <div className='flex flex-1 md:flex-auto'>
                        ...
                        <div className='flex items-center text-sm  mr-2'>
                            <a className='block text-ellipsis overflow-hidden whitespace-nowrap rounded-lg px-2 text-center leading-[1.625rem] font-primary font-medium text-light-grey border  py-1  mr-1 hover:border-grey hover:bg-grey hover:text-text-black sm:w-24 md:w-auto md:max-w-[8rem]' >PostgreSQL</a>
                            <a className='block text-ellipsis overflow-hidden whitespace-nowrap rounded-lg px-2 text-center leading-[1.625rem] font-primary font-medium text-light-grey border py-1  mr-1 hover:border-grey hover:bg-grey hover:text-text-black sm:w-24 md:w-auto md:max-w-[8rem]'> Databases</a>
